...
from core.config import ANTHROPIC_API_KEY, ANTHROPIC_MODEL, LLM_PROVIDER, SILVER_DIR
...
def _make_llm():
    ...
    raise ValueError(f"Unsupported LLM_PROVIDER for silver agent: {LLM_PROVIDER!r}")
